...
public class BaseTest {
	...
	static String base_workspace;
	static String workspace;
	static String systemdir;
	static String realpath;

	public static String initWorkspace(String language) throws Exception {
	...
	//未做无效引用处理
	public String compileCAndCPP(String src_name,String extra_flags) throws Exception{
		try {
	...
	public String outputFile_content(String path) throws Exception{
